...
if setup == false
{
	...
	{
		//store characters per each page
		...
		//setting individual characters and text spacing
...
if draw_char == text_length[page] && page == page_number - 1
{
	...
	if option_pos == op
	{
		draw_sprite(spr_dialog_arrow, 0, _txtb_x, _txtb_y - _op_space*option_number + _op_space*op);
	}
